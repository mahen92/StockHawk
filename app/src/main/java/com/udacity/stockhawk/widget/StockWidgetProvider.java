...
public class StockWidgetProvider extends AppWidgetProvider {
    ...
    public static final String INTENT_ACTION = "com.udacity.stockhawk.widget.StockWidgetProvider.INTENT_ACTION";
    public static final String EXTRA_SYMBOL = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_SYMBOL";
    public static final String EXTRA_NAME = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_NAME";
    public static final String EXTRA_CURRENCY = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_CURRENCY";
    public static final String EXTRA_LASTTRADEDATE = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_LASTTRADEDATE";
    public static final String EXTRA_DAYLOW = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_DAYLOW";
    public static final String EXTRA_DAYHIGH = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_DAYHIGH";
    public static final String EXTRA_YEARLOW = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_YEARLOW";
    public static final String EXTRA_YEARHIGH = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_YEARHIGH";
    public static final String EXTRA_EARNINGSSHARE = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_EARNINGSSHARE";
    public static final String EXTRA_MARKETCAPITALIZATION = "com.udacity.stockhawk.widget.StockWidgetProvider.EXTRA_MARKETCAPITALIZATION";
